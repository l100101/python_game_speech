...
walk_right = [pygame.image.load(f"player_sprites/walk_up_{i}.png") for i in range(1, 5)]
walk_left = [pygame.image.load(f"player_sprites/walk_down_{i}.png") for i in range(1, 5)]
...
character_x = 400
character_y = 300
character_speed = 5  # скорость движения в пикселях
